...
def train(epochs,dir):
  model_dir = dir
  given_dir = f'{model_dir}/training_log.txt'
  ...
  for epoch in range(EPOCHS):
    ...
    empty_s += f'Time taken for 1 epoch {time.time() - start} sec\n'
    train_l.append(empty_s)
  with open(given_dir,'w',encoding="utf8") as filelog:
...
if __name__ == '__main__':
  ...
  with open(f'{pic_dir}/input_tensor.pickle', 'wb') as f:
    pickle.dump(input_tensor, f)
  with open(f'{pic_dir}/target_tensor.pickle', 'wb') as f:
    pickle.dump(target_tensor, f)
  with open(f'{pic_dir}/inp_lang.pickle', 'wb') as f:
    pickle.dump(inp_lang, f)
  with open(f'{pic_dir}/targ_lang.pickle', 'wb') as f:
    pickle.dump(targ_lang, f)
  with open(f'{pic_dir}/BATCH_SIZE.pickle', 'wb') as f:
